...
RUN apk update && \
    ...
    apk add git=2.22.5-r0 python2=2.7.18-r0 py-setuptools=40.8.0-r1 py2-isort=4.3.19-r0 py2-tox=3.9.0-r0 && \
    pip install --no-cache-dir coverage==5.5 pylint==1.9.5 pytest==4.6.11 pytest-cov==2.11.1 wheel==0.36.2 && \
